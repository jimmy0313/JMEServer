...
static int pb_repeated_add(lua_State* L)
{
	...
	lua_pbmsg* m = 
		(lua_pbmsg*)luaL_checkudata(L, 2, PB_MESSAGE_META);
...
static int pb_new(lua_State* L)
{
	...
	Message* message = Proto.createDynamicMessage(type_name);
	if (!message)
	{
...
static const struct luaL_reg lib[] =
{
	...
	{"import", pb_import},
	{"debug", pb_tostring},
	{"from_string", pb_parseFromString},
	{"to_string", pb_serializeToString},
	{NULL, NULL}
};
